        ...
        <div className="container mx-auto px-6 md:px-10 flex justify-between items-center">
          <div className="flex items-center space-x-4 md:space-x-8">
            <div className="flex items-center space-x-4 cursor-pointer group" onClick={() => navigateTo('main')}>
              <div className="w-10 h-10 bg-white flex items-center justify-center relative overflow-hidden rounded-sm group-hover:scale-105 transition-transform duration-300">
            ...
            <div className="container mx-auto px-6 md:px-10 relative z-10 flex flex-col items-center">
              ...
              <div className="mb-40">
                <div className="flex items-center space-x-6 mb-20 group">
                  <div className="w-14 h-14 rounded-full bg-white flex items-center justify-center shadow-xl shadow-indigo-600/10 group-hover:scale-110 transition-transform overflow-hidden">
                    <img src="/logo.png" alt="HS" className="w-full h-full object-contain" />
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
            <div className="col-span-1 md:col-span-1">
              <div className="flex items-center space-x-3 mb-8">
                <div className="w-10 h-10 bg-white flex items-center justify-center rounded-sm overflow-hidden">
                  <img src="/logo.png" alt="HS" className="w-full h-full object-contain" />
                </div>
