              ...
              <div className="flex flex-col lg:flex-row gap-12 items-start h-full">
                ...
                <aside className="w-full lg:w-80 lg:sticky lg:top-40 space-y-12">
                  ...
                  <nav className="space-y-2 border-l border-slate-200 pl-6">
                    ...
                    <button
                      onClick={() => { navigateTo('processing'); setBizFilter('all'); }}
                  ...
                  <div className="p-8 bg-white border border-slate-100 rounded-sm space-y-6 shadow-sm">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-[10px] font-mono font-bold text-indigo-600">
                        {String(
                          (view === 'processing')
                            ? productsObj.processed.length
                            : (bizFilter === 'all'
                              ? productsObj.knitting.length + productsObj.raw.length
                              : (bizFilter === 'knitting' ? productsObj.knitting.length : productsObj.raw.length)
                            )
                        ).padStart(3, '0')}
                      </div>
                    </div>
                ...
                <div className="flex-1 w-full h-full">
                  ...
                  <div key={`${view}-${bizFilter}`} className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                    {(view === 'processing'
                      ? productsObj.processed
                      : (bizFilter === 'all'
